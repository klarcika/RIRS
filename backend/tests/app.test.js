...
const app = require('../app');  // Prepričajte se, da aplikacija pravilno izvaža "app"
...
describe('Expense Routes Tests', () => {
    test('POST /dodaj - should add an expense', async () => {
        ...
        expect(expenseController.dodajStrosek).toHaveBeenCalledWith(
            expect.anything(),
            expect.anything()
        );
    });

    test('GET /vsi - should fetch all expenses', async () => {
    ...
    test('GET /oseba - should fetch expenses by person', async () => {
    ...
    test('GET /vsota - should fetch total expenses by person', async () => {
    ...
    test('GET /:id - should fetch an expense by ID', async () => {
    ...
    test('PUT /:id - should update an expense by ID', async () => {
    ...
    test('DELETE /:id - should delete an expense by ID', async () => {
...
describe('User Routes Tests', () => {
    test('POST /dodaj - should add a new user', async () => {
    ...
    test('GET /vsi - should fetch all users', async () => {
    ...
    test('GET /:email - should fetch a user by email', async () => {
